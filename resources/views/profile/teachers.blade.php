...
<head>
    ...
    <title>Teachers - {{ ucfirst($status_type) }}</title>
...
<body>
    <div class="container mt-5">
        ...
        <li class="nav-item">
                <a class="nav-link {{ $status_type === 'active' ? 'active' : '' }}" href="{{ route('profile.teachers.active',['email'=>$email]) }}">Active</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ $status_type === 'rejected' ? 'active' : '' }}" href="{{ route('profile.teachers.rejected',['email'=>$email]) }}">Rejected</a>
            </li>
    ...
    <script>
        function showTeacherInfo(teacherId) {
            fetch(`/profile/teachers/info/${teacherId}`)
