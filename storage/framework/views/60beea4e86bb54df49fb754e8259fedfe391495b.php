...
<div id="blurContent">
    <?php $__currentLoopData = $counters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="container" id="container<?php echo e($counter->name); ?>">
            <div class="conheader"><?php echo e($counter->name); ?>: <?php echo e($counter->counter); ?></div>
            <div class="card-body"></div>
            <div class="card-footer">
                <button class="increment-button" data-name="<?php echo e($counter->name); ?>">Increment</button>
    ...
    <div class="top-counters">
        ...
        <?php $__currentLoopData = $topCounters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topCounter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="top-container">
                <?php echo e($topCounter->name); ?>: <?php echo e($topCounter->counter); ?>
    ...
    <div id="floatingForm">
        ...
        <form id="questionnaireForm">
            ...
            <select name="favoriteContainer" id="favoriteContainer">
                <?php $__currentLoopData = $counters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($counter->name); ?>"><?php echo e($counter->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <br><br>
...
<?php /**PATH C:\xampp\htdocs\crontutorial\resources\views/clicks.blade.php ENDPATH**/ ?>